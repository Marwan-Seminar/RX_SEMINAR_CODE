...
public class FlatMapGroupBy_Base {
	...
	void flapMapGroupBySplitAndMerge() {
		...
		// groupBy() erhaelt als Argument eine Funktion, die jedem Item einen Key zuordnet. Z.B. i -> selector.incrementAndGet() % 4
		
		// TODO 2 flatMap() benutzen, um die Gruppen wieder zusammenzufuehren
		//.flatMap(group -> 
		
		// TODO 3: Elemente jeder Gruppe verarbeiten, innerhalb von flatMap(), z.B. mit group.map( value -> {})
			
		// TODO 4: Subscriber an flatMap() anschliessen	
